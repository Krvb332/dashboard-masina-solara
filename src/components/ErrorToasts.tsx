      ...
      {visible.map((entry) => {
        ...
        return (
          <div
            ...
            className={clsx(
              'pointer-events-auto flex w-full items-start gap-3 rounded-xl border p-3 shadow-2xl shadow-black/50 backdrop-blur-md',
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <button
                ...
                className="mt-2 text-xs font-medium text-current/80 underline underline-offset-2 hover:text-current"
              >
                Vezi toate erorile
              </button>
            </div>
